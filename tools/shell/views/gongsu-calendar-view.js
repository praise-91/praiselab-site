...
import { auth, db, onProfile } from '../firebase-shell.js?v=22';

const STYLE_HREF = '/tools/shell/views/gongsu-calendar.css?v=22';
...
export function mount(container) {
  ...
  async function startReactApp() {
    ...
    if (cancelled) return;
    const { App } = await import('./gongsu-calendar-app.js?v=22');
    if (cancelled) return;
