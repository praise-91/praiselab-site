...
// 셸 참조가 0건인지 확인할 것.
import { authReady, getAppCheckActivationCount } from './firebase-shell.js?v=5';
import { registerView, navigate, currentViewFromUrl, flagShellUpdate } from './router.js?v=5';

registerView('home', () => import('./views/home-view.js?v=5'));
registerView('community', () => import('./views/community-view.js?v=5'));
registerView('tool-rental', () => import('./views/tool-rental-view.js?v=5'));
registerView('roulette', () => import('./views/roulette-view.js?v=5'));
registerView('team-ladder', () => import('./views/team-ladder-view.js?v=5'));
registerView('games', () => import('./views/games-view.js?v=5'));
registerView('qty-report', () => import('./views/qty-report-view.js?v=5'));
registerView('admin-dashboard', () => import('./views/admin-dashboard-view.js?v=5'));
registerView('gongsu-admin', () => import('./views/gongsu-admin-view.js?v=5'));
registerView('gongsu-calendar', () => import('./views/gongsu-calendar-view.js?v=5'));
